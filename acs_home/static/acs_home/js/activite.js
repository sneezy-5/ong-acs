...
containers.forEach(container=>{
    container.addEventListener('click',function(){
        ...
        /**recup img */
        var img=container.querySelector('.imgcontainer');
        var sourceImg=img.src

        /**recup titre */
        var titrecontainers=container.querySelector('.Titrecontainer')
        var valuetitre=titrecontainers.innerHTML

        /**recup text */
        var text=container.querySelector('.textcontainer')
        var valuetext=text.innerHTML

        /**transfert vers spoileractiviter */
        localStorage.setItem('srcimg',sourceImg)
        localStorage.setItem('valeurtitre',valuetitre)
        localStorage.setItem('valeurtext',valuetext)
    })
})
...
if(window.location.pathname==="/activite.html"){
